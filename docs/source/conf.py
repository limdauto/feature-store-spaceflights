...
# feature_store_spaceflights documentation build
...
from feature_store_spaceflights import __version__ as release

# -- Project information -----------------------------------------------------

project = "feature_store_spaceflights"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "feature_store_spaceflightsdoc"
...
latex_documents = [
    (
        master_doc,
        "feature_store_spaceflights.tex",
        "feature_store_spaceflights Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "feature_store_spaceflights",
        "Project feature_store_spaceflights codebase.",
        "Data-Science",
    )
]
